...
Scene::Scene()
{
	...
	m_LightData.m_DirLight.m_Color.m_Ambient = glm::vec3(0.1f);
	m_LightData.m_DirLight.m_Color.m_Diffuse = glm::vec3(0.6f);
	m_LightData.m_DirLight.m_Color.m_Specular = glm::vec3(1.0f);

	m_LightData.m_PointLights[0].SetIsEnabled(true);
	m_LightData.m_PointLights[0].SetPosition(glm::vec3(5.0f, 3.0f, 0.0f));
	m_LightData.m_PointLights[0].m_Color.m_Ambient = glm::vec3(0.1f, 0.0f, 0.0f);
	m_LightData.m_PointLights[0].m_Color.m_Diffuse = glm::vec3(0.8f, 0.0f, 0.0f);
	m_LightData.m_PointLights[0].m_Color.m_Specular = glm::vec3(1.0f, 0.0f, 0.0f);
	...
	m_LightData.m_SpotLights[0].m_Color.m_Ambient = glm::vec3(0.0f, 0.0f, 0.05f);
	m_LightData.m_SpotLights[0].m_Color.m_Diffuse = glm::vec3(0.0f, 0.0f, 0.7f);
	m_LightData.m_SpotLights[0].m_Color.m_Specular = glm::vec3(0.0f, 0.0f, 1.0f);
}
